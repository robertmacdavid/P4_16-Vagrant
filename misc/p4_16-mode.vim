...
" Var Attributes
syn keyword p4TypeAttribute           const in out inout
...
" Integer Literals
syn match   p4DecimalInt     '\b([1-9]+(s|w))?(\-)?[1-9][0-9]*\b' transparent
syn match   p4HexadecimalInt '\b0[xX][0-9a-fA-F]+\w\b' transparent
